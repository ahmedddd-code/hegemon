...
import { WHATSAPP_BOOKING_URL, WHATSAPP_PHONE_LABEL } from '../lib/contact';
  ...
  return (
    <footer className="footer">
      <div className="section-wrap footer__top">
        ...
        <div><span>СВЯЗЬ</span><a href={WHATSAPP_BOOKING_URL} target="_blank" rel="noreferrer">{WHATSAPP_PHONE_LABEL} ↗</a><p>WhatsApp · только по записи</p></div>
      </div>
