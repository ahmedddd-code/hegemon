      ...
      <section className="founder-story">
        <div className="founder-story__inner section-wrap">
          ...
          <div className="founder-story__copy">
            ...
            <p className="founder-story__origin">Так появился <strong>HEGEMON — пространство, созданное вокруг потребностей мужчины.</strong></p>
            ...
            <footer><strong>Жанбота Алтынтогыс</strong><em>Основатель HEGEMON</em></footer>
          </div>
        </div>
      </section>
