  ...
  return (
    <section className="principles" id="about">
      <div className="principles__content">
        ...
        <div className="principles__intro"><p className="lead">HEGEMON — пространство, созданное мужчинами для мужчин.</p><p>Здесь уход за телом — нормальная часть жизни. Без стеснения, оценок и ненужной суеты.</p></div>
